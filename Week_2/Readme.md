...
![Final Integrated Layout](Images/Week_2_1.png)
...
```
![Standard Cell Placement Density](Images/Week_2_2.png)
...
```
![Final Routed Signal Interconnects](Images/Week_2_3.png)
...
```
 ![Clock Network Distribution Tree](Images/Week_2_4.png) 
...
![CTS H-Tree Schematic View](Images/Week_2_5.png)
...
![CTS Buffer Spatial Layout](Images/Week_2_6.png)
...
```
![Localized Routing Congestion Heatmap](Images/Week_2_7.png)
...
![Static IR-Drop Supply Integrity Report](Images/Week_2_8.png)
